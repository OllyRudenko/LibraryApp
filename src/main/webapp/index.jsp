...
<main>
    ...
    <section class="py-5 text-center container">
        <div class="row py-lg-1">
            ...
            <p class="text-right lang">
                ...
                <a class="c-pointer font-weight-bolder" th:classappend="${editData.locale.toString() eq 'UK'}? 'color-dark-red'"
                   th:href="@{'/materials/news/update/' + ${slug}(locale='UK')}">UA</a>
                <span class="mr-1 ml-1">/</span>
                <a class="c-pointer font-weight-bolder" th:classappend="${editData.locale.toString() eq 'EN'}? 'color-dark-red'"
                   th:href="@{'/materials/news/update/' + ${slug}(locale='EN')}">EN</a>
            </p>
        </div>
        <div class="row py-lg-1">
            <div class="col-lg-6 col-md-8 mx-auto">
                ...
                <p>
                    <a href="templates/login.html" class="btn btn-primary my-2">Sing in</a>
                    <a href="templates/registration.html" class="btn btn-secondary my-2">Sing up</a>
                </p>
            </div>
        </div>
    </section>
    ...
    <div class="album py-5 bg-light">
        <div class="container">
            <p class="lead text-muted">NEW BOOKS</p>
