            ...
            <tbody>
                <c:forEach items="${authors}" var="author">
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')" href="/libraryApp/controller?command=deleteAuthorProfile&userRole=${userRole}&id=${author.authorId}&locale=${author.local}&userId=${userId}">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
